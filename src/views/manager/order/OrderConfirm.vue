<template>
    <div class="confirm">
        <x-fulllayout title='订单确认'>
            <div class="wrapper" style='margin:1.5em'>
                <van-row @click='pickAddressHandler'>
                    <van-col span="4">
                        <van-icon size='26' class-prefix="iconfont icon-address" name="extra" />
                    </van-col>
                    <van-col span="18">
                        <div>服务地址</div>
                ...
                <van-row>
                    <van-col span="4">
                        <van-icon size='26' class-prefix="iconfont icon-dindan" name="extra" />
                    </van-col>
                    <van-col span="20">
                        <div style="margin-bottom:1em;">订单详情</div>
                        <div v-for='item in orderLines.values()' :key='item.id'>
                            <van-row style="margin-bottom:.5em;">
                                <van-col span="16">{{item.productName}}</van-col>
                                <van-col span="4">x {{item.number}}</van-col>
                                <van-col span="4">￥ {{item.price}}</van-col>
                            </van-row>
                        </div>
                        <div style='text-align:right;padding:0 2em'>总额：￥ {{total}}</div>
                    </van-col>
                </van-row>
                
                <van-row>
                    <van-col span="4">
                        <van-icon size='26' class-prefix="iconfont icon-time" name="extra" />
                    </van-col>
                    <van-col span="18">
                        <div style="line-height:2.5em">服务时间</div>
                        <div>
                            {{currentTime}}
                ...
                <van-row>
                    <van-col span="4">
                        <van-icon size='26' class-prefix="iconfont icon-pay" name="extra" />
                    </van-col>
                    <van-col span="18">
                        <div>支付方式</div>
                        <div>支付方式</div>
